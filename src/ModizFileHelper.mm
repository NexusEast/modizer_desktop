    ...
    switch (ftype) {
        case FTYPE_PLAYABLEFILE: {
            ...
            filetype_ext=[NSMutableArray arrayWithCapacity:[filetype_extMDX count]+
                          ...
                          [filetype_extWSR count]+
                          [filetype_extZXTUNE count]+
            ...
            [filetype_ext addObjectsFromArray:filetype_extZXTUNE];
        ...
        case FTYPE_PLAYABLEFILE_AND_DATAFILE: {
            ...
            NSArray *filetype_extNCSF=[SUPPORTED_FILETYPE_NCSF_EXT componentsSeparatedByString:@","];
            NSArray *filetype_extV2M=[SUPPORTED_FILETYPE_V2M componentsSeparatedByString:@","];
            NSArray *filetype_extVGMSTREAM=[SUPPORTED_FILETYPE_VGMSTREAM componentsSeparatedByString:@","];
        ...
        case FTYPE_SINGLE_FILETYPE:{
            ...
            [filetype_ext addObjectsFromArray:[SUPPORTED_FILETYPE_FUR componentsSeparatedByString:@","]];
            ...
            [filetype_ext addObjectsFromArray:[SUPPORTED_FILETYPE_WSR componentsSeparatedByString:@","]];
            [filetype_ext addObjectsFromArray:[SUPPORTED_FILETYPE_ZXTUNE componentsSeparatedByString:@","]];
...
+(int) isAcceptedFile:(NSString*)_filePath no_aux_file:(int)no_aux_file rar_rsn_mode:(bool)rar_rsn_mode {
    ...
    NSArray *filetype_extNCSF=(no_aux_file?[SUPPORTED_FILETYPE_NCSF componentsSeparatedByString:@","]:[SUPPORTED_FILETYPE_NCSF_EXT componentsSeparatedByString:@","]);
    NSArray *filetype_extV2M=[SUPPORTED_FILETYPE_V2M componentsSeparatedByString:@","];
    ...
    if (!found)
        for (int i=0;i<[filetype_extFUR count];i++) {
            if ([extension caseInsensitiveCompare:[filetype_extFUR objectAtIndex:i]]==NSOrderedSame) {found=MMP_FUR;break;}
            if ([file_no_ext caseInsensitiveCompare:[filetype_extFUR objectAtIndex:i]]==NSOrderedSame) {found=MMP_FUR;break;}
        }
    if (!found)
    ...
    if (!found)
        for (int i=0;i<[filetype_extWSR count];i++) {
            if ([extension caseInsensitiveCompare:[filetype_extWSR objectAtIndex:i]]==NSOrderedSame) {found=MMP_WSR;break;}
            if ([file_no_ext caseInsensitiveCompare:[filetype_extWSR objectAtIndex:i]]==NSOrderedSame) {found=MMP_WSR;break;}
        }
    if (!found)
        for (int i=0;i<[filetype_extZXTUNE count];i++) {
            if ([extension caseInsensitiveCompare:[filetype_extZXTUNE objectAtIndex:i]]==NSOrderedSame) {found=MMP_ZXTUNE;break;}
            if ([file_no_ext caseInsensitiveCompare:[filetype_extZXTUNE objectAtIndex:i]]==NSOrderedSame) {found=MMP_ZXTUNE;break;}
        }
    if (!found)
    ...
    if (!found)
        for (int i=0;i<[filetype_extNCSF count];i++) {
            if ([extension caseInsensitiveCompare:[filetype_extNCSF objectAtIndex:i]]==NSOrderedSame) {
                //check if .miniXXX or .XXX
                NSArray *singlefile=[SUPPORTED_FILETYPE_NCSF_WITHEXTFILE componentsSeparatedByString:@","];
                for (int j=0;j<[singlefile count];j++)
                    if ([extension caseInsensitiveCompare:[singlefile objectAtIndex:j]]==NSOrderedSame) {
                        break;
                    }
                found=MMP_NCSF;break;
            }
